...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |-----------------------------------------------------------------------------------------+
   * | Shift     |  Z  |  X  |  C  |  V  |  B  |  N  |  M  |  ,  |  .  |  R Shift  |  U  | DEL |
   * |-----------------------------------------------------------------------------------------+
  ...
  LAYOUT_directional(
      ...
      KC_LCTL, KC_LALT, KC_SPC, KC_SPC, KC_SPC, KC_SPC, KC_RALT, MO(1), KC_LEFT, KC_DOWN, KC_RIGHT
      ),
  ...
  LAYOUT_directional(
      ...
      ______ , ______, ______, ______, ______, ______, KC_RCTL, ______, KC_PGUP, KC_END, KC_PGDN
      ),
};
